//
// Created by chensn on 2016/12/30.
//
...
//        }
        void testCase10(){
            ...
            stdVec< int > stdfoo{ 100, 100, 100 };
            stdVec < int > stdbar{200, 200};
            assert(TinySTL::Test::container_equal(foo, stdfoo));
            assert(TinySTL::Test::container_equal(bar, stdbar));
        }
        void testCase11(){
